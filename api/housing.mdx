...
Retrieve the image for a specific housing listing.

**Endpoint**: `GET /v1/api/houses/{id}/image`
...
**Response**: Returns the image as `image/jpeg`
...
Upload or update the image for a housing listing.

**Endpoint**: `PUT /v1/api/houses/{id}/image`
